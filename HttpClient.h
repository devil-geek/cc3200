...
#else
    HttpClient(Client& aClient, bool useSSL);
#endif
...
protected:
    ...
    */
    ...
    int checkSSLAndconnect(const char* aServerName, uint16_t aServerPort);
    int checkSSLAndconnect(IPAddress ip, uint16_t aServerPort);
    bool m_useSSL;
};
